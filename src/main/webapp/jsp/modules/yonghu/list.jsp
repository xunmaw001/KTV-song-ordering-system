...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="yonghuzhanghaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>头像</th>
											<th onclick="sort('yonghushouji')">用户手机<i id="yonghushoujiIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#yonghuzhanghaoSearch').val() != null && $('#yonghuzhanghaoSearch').val() != ''){
				searchForm.yonghuzhanghao ="%" +  $('#yonghuzhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("yonghu/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				yonghuzhanghao : searchForm.yonghuzhanghao,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var yonghushoujiCell  = document.createElement('td');

						 yonghushoujiCell.innerHTML = item.yonghushouji;


			row.appendChild(yonghushoujiCell);
